...
func (s *Service) DeleteCard(cardID, userID int) (err error) {
	return s.Store.DeleteCard(cardID, userID)
}

func (s *Service) FindCard(cardID, userID int) (card model.DataCard, err error) {
	return s.Store.FindCard(cardID, userID)
}
...
func (s *Service) FindFile(fileID, userID int) (file model.DataFile, err error) {
	return s.Store.FindFile(fileID, userID)
}
...
func (s *Service) DeleteCred(credID, userID int) (err error) {
	return s.Store.DeleteCred(credID, userID)
}

func (s *Service) FindCred(credID, userID int) (cred model.DataCred, err error) {
	return s.Store.FindCred(credID, userID)
}
...
func (s *Service) DeleteText(textID, userID int) (err error) {
	return s.Store.DeleteText(textID, userID)
}

func (s *Service) FindText(textID, userID int) (text model.DataText, err error) {
	return s.Store.FindText(textID, userID)
}
